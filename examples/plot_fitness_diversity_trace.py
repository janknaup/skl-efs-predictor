...
from evolutionary_feature_selection import EvolutionaryFeatureSelection, fitness_diversity_trace
...
fig = fitness_diversity_trace(efs.fitness_history_, std=True, range=True)
fig.show()
